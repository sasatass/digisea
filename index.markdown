...
<section id="challenge">
    <div class="container">
        ...
        <div class="stat-grid">
            <div class="stat-card">
                <img src="/assets/images/stat1.png" alt="Stat Icon" class="stat-icon" />
                <h3>71%</h3>
            ...
            <div class="stat-card">
               <img src="/assets/images/stat2.png" alt="Stat Icon" class="stat-icon" />
                <h3>80%</h3>
                <p>of B2B buyers rely on peer recommendations when making software purchasing decisions.</p>
                <small>Source: Gartner</small>
            </div>
            <div class="stat-card">
               <img src="/assets/images/stat3.png" alt="Stat Icon" class="stat-icon" />
                <h3>42%</h3>
    ...
    <div class="container">
        ...
        <div class="vision-content">
            ...
            <div class="vision-image">
                <img src="/assets/images/vision1.png" alt="Our Vision" />
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="insight-grid">
            <div class="insight-card">
                <img src="/assets/images/insight1.png" alt="Tech Icon" class="insight-icon" />
                <h3>$278.8 billion</h3>
            ...
            <div class="insight-card">
            <img src="/assets/images/insight2.png" alt="Graph Icon" class="insight-icon" />
                <h3>69%</h3>
    ...
    <div class="container">
        ...
        <div class="solution-content reverse">
            ...
            <div class="solution-image">
                <img src="/assets/images/solution1.png" alt="Our Solution" />
            </div>
        </div>
    </div>
</section>
